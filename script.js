...
const LOCATIONS = {
  easy: [
    ...
    { name: "Geneva, Switzerland", lat: 46.2022, lng: 6.1432 },
  ...
  medium: [
    ...
    { name: "Verona, Italy", lat: 45.4386, lng: 10.9945 },
    { name: "Salamanca, Spain", lat: 40.9669, lng: -5.6638 },
    { name: "Dubrovnik, Croatia", lat: 42.6408, lng: 18.1091 },
    { name: "Cusco, Peru", lat: -13.5319, lng: -71.9753 },
    { name: "Quito, Ecuador", lat: -0.2192, lng: -78.5125 },
  ...
  hard: [
    ...
    { name: "Gobi Desert, Mongolia", lat: 42.5, lng: 104.0 },
    { name: "Namib Desert, Namibia", lat: -24.0, lng: 14.5 },
    { name: "Outback, Australia", lat: -25.2744, lng: 133.7751 },
    { name: "Death Valley, USA", lat: 36.2841, lng: -116.8514 },
    { name: "Siberia, Russia", lat: 65.0, lng: 105.0 },
    { name: "Lappland, Sweden", lat: 67.0, lng: 20.0 },
    { name: "New Zealand Bush", lat: -42.7339, lng: 171.1865 },
    { name: "Kalahari Desert, Botswana", lat: -22.5, lng: 22.0 },
    { name: "Norwegian Fjords", lat: 60.5, lng: 6.0 },
    { name: "Transylvania, Romania", lat: 46.9, lng: 24.9 },
    { name: "Lake District, England", lat: 54.5, lng: -3.2 },
    { name: "Dolomites, Italy", lat: 46.4, lng: 12.0 },
  ],
  impossible: [
    { name: "Sahara Desert, Algeria", lat: 25.5, lng: 2.0 },
    { name: "Arabian Desert, Saudi Arabia", lat: 25.0, lng: 45.0 },
    { name: "Mojave Desert, USA", lat: 35.5, lng: -115.5 },
    { name: "Sonoran Desert, USA", lat: 32.0, lng: -113.0 },
    { name: "Great Sandy Desert, Australia", lat: -22.0, lng: 128.0 },
    { name: "Simpson Desert, Australia", lat: -25.0, lng: 138.5 },
    { name: "Rub' al Khali, UAE", lat: 23.5, lng: 52.0 },
    { name: "Taklamakan Desert, China", lat: 39.0, lng: 80.5 },
    { name: "Kyzylkum Desert, Kazakhstan", lat: 42.0, lng: 67.0 },
    { name: "Karakum Desert, Turkmenistan", lat: 40.0, lng: 64.0 },
    { name: "Atacama Desert, Chile", lat: -23.0, lng: -69.0 },
    { name: "Andean Salt Flat, Bolivia", lat: -20.3, lng: -67.5 },
    { name: "Lut Desert, Iran", lat: 30.5, lng: 58.5 },
    { name: "Negev Desert, Israel", lat: 31.0, lng: 34.8 },
    { name: "Chihuahuan Desert, Mexico", lat: 30.0, lng: -105.0 },
    { name: "Great Basin, USA", lat: 39.0, lng: -115.5 },
    { name: "Thar Desert, India", lat: 27.5, lng: 71.0 },
    { name: "Danakil Depression, Ethiopia", lat: 12.2, lng: 41.3 },
    { name: "Wadqi Rum, Jordan", lat: 30.3, lng: 35.4 },
    { name: "White Sands, USA", lat: 32.8, lng: -106.3 },
    { name: "Skeleton Coast, Namibia", lat: -22.5, lng: 12.0 },
    { name: "Atacama Salt Flat, Chile", lat: -24.2, lng: -69.2 },
    { name: "Death Valley, USA (remote)", lat: 36.5, lng: -116.9 },
    { name: "Empty Quarter, Arabia", lat: 22.0, lng: 50.0 },
    { name: "Gobi Desert Deep", lat: 40.0, lng: 105.0 },
    { name: "Altai Mountains Remote, Mongolia", lat: 49.5, lng: 88.0 },
    { name: "Australian Outback Deep", lat: -22.0, lng: 134.0 },
    { name: "Iceland Highlands", lat: 64.8, lng: -18.0 },
    { name: "Atacama Puna, Argentina", lat: -25.0, lng: -68.0 },
    { name: "Tibetan Plateau", lat: 33.0, lng: 85.0 },
  ],
};
